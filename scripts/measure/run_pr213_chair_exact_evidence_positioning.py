#!/usr/bin/env python3
"""Run PR21.3 chair exact-evidence interpretation and positioning report."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pr201-chair-dir", type=Path)
    parser.add_argument("--pr211-drums-dir", type=Path)
    parser.add_argument("--pr211fa-drums-dir", type=Path)
    parser.add_argument("--pr211g-drums-dir", type=Path)
...
def main() -> int:
    ...
    try:
        summary, exit_code = build_pr213_chair_exact_evidence_positioning(
            ...
            pr201_chair_dir=_resolve_path(project_root, args.pr201_chair_dir),
            pr211_drums_dir=_resolve_path(project_root, args.pr211_drums_dir),
            pr211fa_drums_dir=_resolve_path(project_root, args.pr211fa_drums_dir),
            pr211g_drums_dir=_resolve_path(project_root, args.pr211g_drums_dir),
            scene=args.scene,
