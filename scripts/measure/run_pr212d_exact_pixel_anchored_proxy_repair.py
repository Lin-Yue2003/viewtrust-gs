#!/usr/bin/env python3
"""Run PR21.2d exact-pixel-anchored PR20 proxy repair."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pr212c-chair-dir", required=True, type=Path)
    parser.add_argument("--pr212cfix-chair-dir", required=True, type=Path)
...
def main() -> int:
    ...
    try:
        summary, exit_code = build_pr212d_exact_pixel_anchored_proxy_repair(
            ...
            pr212c_chair_dir=_resolve_path(project_root, args.pr212c_chair_dir),
            pr212cfix_chair_dir=_resolve_path(project_root, args.pr212cfix_chair_dir),
