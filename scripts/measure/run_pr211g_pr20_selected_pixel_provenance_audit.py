#!/usr/bin/env python3
"""Run PR21.1g PR20 selected-pixel provenance audit."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pr211f-dir", required=True, type=Path)
...
def main() -> int:
    ...
    try:
        summary, exit_code = build_pr211g_pr20_selected_pixel_provenance_audit(
            pr200_dir=_resolve_path(project_root, args.pr200_dir),
            pr211f_dir=_resolve_path(project_root, args.pr211f_dir),
