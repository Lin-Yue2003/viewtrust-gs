#!/usr/bin/env python3
"""Run PR21.2a chair exact-vs-proxy ID namespace audit."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--sample-id-count", type=int, default=20)
...
def main() -> int:
    ...
    try:
        summary, exit_code = build_pr212a_chair_id_namespace_audit(
